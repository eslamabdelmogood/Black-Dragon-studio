...
from app.engineering_team import run_engineering_team  # noqa: E402
...
def test_generate_project_produces_expected_structure():
    ...
    agents = run_engineering_team(spec)
    manifest = generate_project(spec, "proj0001", out_dir, agents)
...
def test_full_validation_pipeline_passes_for_demo_prompt():
    ...
    manifest = generate_project(spec, "proj0003", out_dir, run_engineering_team(spec))
